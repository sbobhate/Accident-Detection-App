...
//        }
        ...
        if(v.getId()==R.id.text_login)
        {
            ...
            else if(flag==1)
            {
                if(edit_user.getText().toString().contains("@"))
                    ...
                    session1.createLoginSession(edit_user.getText().toString(), db.getCustomerInfo("email","username",edit_user.getText().toString()));
    ...
    public int exist() {
        ...
        else if (edit_pass.getText().toString().equals(db.getCustomerInfo("password","username",edit_user.getText().toString())))
            flag=1;
        else
            flag=0;
        return flag;
